...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="container">
            <div class="row">                
                <form action="{{route('agregar')}}" method="POST" class="">
                    <div class="form-group row">
                        ...
                        <div class="form-group col-sm-3 ">
                            ...
                            {{-- <input type="number" name="ejemplares" class="form-control" placeholder="1"> --}}
                        </div>
                        <div class="form-group col-sm-3 ">
                            @csrf
                    ...
                    <tbody>
                        @foreach ($revistas as $revista)
                            <tr>
                                ...
                                <td>
                                    <form action="{{route('eliminar',$revista)}}" method="POST">
                                        @method('DELETE')
                                        @csrf
                                        <button  
                                            type="submit" 
